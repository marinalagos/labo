...
# Cargamos el dataset
dataset <- fread("./datasets/competenciaFINAL_2022_PROBA.csv.gz")
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "DR9151"

PARAM$exp_input  <- "CA9070"
