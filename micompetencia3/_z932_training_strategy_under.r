...
PARAM$final_train  <- c(202104, 202105)#c( 202103, 202104, 202105 )

PARAM$train$training     <- c(202104, 202105)#c( 202101, 202102, 202103 )
PARAM$train$validation   <- c(202104, 202105)#c( 202104 )
PARAM$train$testing      <- c(202104, 202105)#c( 202105 )
...
PARAM$train$semilla_sampling  <- 838609
PARAM$train$semilla_under     <- 882019
...
## para los meses train$training, agrega una columna"azar_sampling" que tiene números aleatorios entre 0 y 1 
...
## para los meses train$training, agrega una columna"azar_under" que tiene números aleatorios entre 0 y 1 

dataset[  , fold_train := 0L ]
## crea una columna para todo el dataset "fold_train" llena de ceros
