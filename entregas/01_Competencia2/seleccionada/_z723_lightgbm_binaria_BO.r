...
PARAM$experimento  <- "HT7250"

#PARAM$input$dataset       <- 'C:/Users/marin/Maestria/2022_2C/00_DMEyF/datasets/competencia2_2022.csv.gz' #"./datasets/competencia2_2022.csv.gz"
#PARAM$input$dataset       <- 'C:/Users/marin/Maestria/2022_2C/00_DMEyF/datasets/dataset2da_v02.csv' #"./datasets/competencia2_2022.csv.gz"
PARAM$input$dataset       <- 'C:/Users/marin/Maestria/2022_2C/00_DMEyF/competencias/01_Segunda_competencia/dataset2da_v05.csv'
#$input$dataset       <- 'C:/Users/marin/Maestria/2022_2C/00_DMEyF/competencias/01_Segunda_competencia/Replicabilidad/dataset2da_v02.csv'
PARAM$input$training      <- c( 202103 )

PARAM$trainingstrategy$undersampling  <-  1   # un undersampling de 0.1  toma solo el 10% de los CONTINUA
PARAM$trainingstrategy$semilla_azar   <- 838609  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 838609  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy

PARAM$hyperparametertuning$weight_baja2 <- 1.0000002 #2
...
fganancia_logistic_lightgbm  <- function( probs, datos) 
{
  ...
  #vector de ganancias
  vgan  <- ifelse( vpesos == PARAM$hyperparametertuning$weight_baja2, PARAM$hyperparametertuning$POS_ganancia, 
...
EstimarGanancia_lightgbm  <- function( x )
{
  ...
  param_basicos  <- list( objective= "binary",
                          ...
                          num_threads = 2
                          #boosting = 'dart', drop_seed = 838609
                        )
...
#setwd('C:/Users/marin/Maestria/2022_2C/00_DMEyF/labo/') #setwd("~/buckets/b1/")   #Establezco el Working Directory
setwd('C:/Users/marin/Maestria/2022_2C/00_DMEyF/competencias/01_Segunda_competencia/Replicabilidad/')
...
dtrain  <- lgb.Dataset( data= data.matrix(  dataset[ training == 1L, campos_buenos, with=FALSE]),
                        ...
                        weight=  dataset[ training == 1L, ifelse( clase_ternaria=="BAJA+2", PARAM$hyperparametertuning$weight_baja2, ifelse( clase_ternaria=="BAJA+1",  1.0000001, 1.0) )],
                        free_raw_data= FALSE  )
